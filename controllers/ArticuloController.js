...
module.exports = {
    ...
    update: async(req, res, next) => {
        try {
            ...
            const reg = await models.Articulo.update({ categoriaId: req.body.categoria, imagen: req.body.imagen, codigo: req.body.codigo, nombre: req.body.nombre, descripcion: req.body.descripcion, precio_venta: req.body.precio_venta, stock: req.body.stock }, { where: { id: req.body.id } });
